...
RUN mkdir -p /opt/gitpod/.dotnet/tools && chmod +r /opt/gitpod && chmod +r /opt/gitpod/.dotnet && chmod +rx /opt/gitpod/.dotnet/tools && dotnet tool install Amazon.Lambda.Tools --tool-path /opt/gitpod/.dotnet/tools
